...
import { VideoContainer, useVideo, VideoCtx } from '../../hooks/useVideo';
import { AudioContainer, AudioCtx } from '@/hooks/useAudio';
    ...
    <div>
      <VideoContainer>
        <AudioContainer>
          <Video
            controls
            src="https://media-cdn.epicgames.com/e64f5e146efb40bb916a40fbf09761e1/e64f5e146efb40bb916a40fbf09761e1-high.webm"
          />
          <PlayButton />
          <Audio />
        </AudioContainer>
